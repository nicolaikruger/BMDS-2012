...
@XmlRootElement(name = "GetAttendantTasks")
public class GetAttendantTasks {

    @XmlElementRef(name = "attendantId", namespace = "http://itu.dk/smds-e2012/lab/week-04/", type = JAXBElement.class, required = false)
